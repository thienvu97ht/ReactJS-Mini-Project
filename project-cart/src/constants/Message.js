...
export const MSG_UPDTAE_CART_SUCCESS = "Cập nhật giỏ hành thành công !";
...
export const MSG_WELCOME = "Chào mừng đến với Shoping Online";
export const MSG_INVENTORY_EMPTY = "Sản phẩm trong kho đã hết";
